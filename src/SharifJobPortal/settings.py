...
SECRET_KEY = 'h_ks&)0x%ymuvi&c%4k@(++t2xa4yx0v=@&pj0t=b9)le0buy@'
...
ROOT_URLCONF = 'SharifJobPortal.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'SharifJobPortal.wsgi.application'
